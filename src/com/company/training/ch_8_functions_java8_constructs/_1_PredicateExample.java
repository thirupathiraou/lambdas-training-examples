...
public class _1_PredicateExample {
    ...
    //using Predicate ,which is out of the box functional interface
    private static void printNamesWithConditionsMet(List<Student> students, Predicate<Student> predicate){
